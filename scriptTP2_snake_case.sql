...
ALTER TABLE Aviao
ADD FOREIGN KEY (modelo) REFERENCES Tipo(modelo);

ALTER TABLE Voo
ADD FOREIGN KEY (registro) REFERENCES Aviao(registro);

ALTER TABLE Voo
ADD FOREIGN KEY (cpf_piloto) REFERENCES Piloto(cpf);

ALTER TABLE Voo
ADD FOREIGN KEY (codigo_itinerario) REFERENCES Itinerario(codigo);
...
ALTER TABLE TelefonePassageiro 
ADD FOREIGN KEY (cpf_passageiro) REFERENCES Passageiro(cpf) 
ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE TrabalhaEm
ADD FOREIGN KEY (cpf_comissario) REFERENCES ComissarioBordo(cpf)
ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE TrabalhaEm
ADD FOREIGN KEY (codigo_voo) REFERENCES Voo(codigo)
ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE Pet
ADD FOREIGN KEY (codigo_passagem) REFERENCES Passagem(codigo);

ALTER TABLE Pet
ADD FOREIGN KEY (nome_raca) REFERENCES Raca(nome);

ALTER TABLE Bagagem
ADD FOREIGN KEY (codigo_passagem) REFERENCES Passagem(codigo);

ALTER TABLE Itinerario
ADD FOREIGN KEY (aeroporto_origem) REFERENCES Aeroporto(nome);

ALTER TABLE Itinerario
ADD FOREIGN KEY (aeroporto_destino) REFERENCES Aeroporto(nome);
